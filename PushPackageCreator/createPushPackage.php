...
$certificate_path = "/Users/dvd/Documents/WebPushPOC/PushPackageCreator/Certificates.p12";
...
function create_signature($package_dir, $cert_path, $cert_password) {
    ...
    //openssl_pkcs7_sign("$package_dir/manifest.json", $signature_path, $cert_data, $private_key, array(), PKCS7_BINARY | PKCS7_DETACHED, "/Users/dvd/Documents/WebPushPOC/PushPackageCreator/AWDRCA.pem");
    openssl_pkcs7_sign("$package_dir/manifest.json", $signature_path, $cert_data, $private_key, array(), PKCS7_BINARY | PKCS7_DETACHED, "/Users/dvd/Documents/WebPushPOC/PushPackageCreator/dvd_AWWDRCA.pem");
...
function create_push_package() {
    ...
    $package_dir = '../safariPackage/pushPackage';
